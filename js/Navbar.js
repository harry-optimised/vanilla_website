    ...
    this.innerHTML = `
      <div class="nav-bar">
        <div class="nav-bar-left">
          <a href="/index.html"><img src="images/logo.png" alt="harry turner logo"/></a>
        ...
        <a href="https://www.linkedin.com/in/harry-j-turner/"><img style="width: 24px" src="https://cdn-icons-png.flaticon.com/512/174/174857.png" alt="harry turner logo"/></a>     
      </div>
    `
  }
}
